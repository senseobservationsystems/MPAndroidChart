...
public class LineDataSet extends LineRadarDataSet<Entry> {
    ...
    /**
     * List representing all colors that are used for the circles hole
     */
    ...
    public LineDataSet(List<Entry> yVals, String label) {
        ...
        mCircleHoleColors.add(Color.rgb(140, 234, 255));
    }
    ...
    public DataSet<Entry> copy() {
        ...
        copied.mCircleHoleColors = mCircleHoleColors;
    ...
    public int getCircleHoleColor(int index) {
        return mCircleHoleColors.get(index % mCircleHoleColors.size());
    }
