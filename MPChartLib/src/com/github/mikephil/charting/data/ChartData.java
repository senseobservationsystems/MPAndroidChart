...
public abstract class ChartData<T extends DataSet<? extends Entry>> {
	 ...
	 * 
	 * @param xVals
	 *            The values describing the x-axis. Must be at least as long as
	 *            the highest xIndex in the Entry objects across all DataSets.
	 * @param sets
	 *            the dataset array
	 */
	...
	public boolean removeEntry(Entry e, int dataSetIndex) {
		...
		boolean removed = mDataSets.get(dataSetIndex)
				.removeEntry(e.getXIndex());
